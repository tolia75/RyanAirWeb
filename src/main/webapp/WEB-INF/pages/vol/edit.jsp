	...
	<c:choose>
		<c:when test="${i==1}">
			...
			<form:form method="get" modelAttribute="vol" action="${action}">
				...
				<form:hidden path="dateArrivee" />
				<form:hidden path="heureArrivee" />
				<form:hidden path="arrivee.id" />
				...
				<div class="form-group">
					<form:label path="depart.id">Aeroport : </form:label>
					<form:select path="depart.id" cssClass="form-control">
						<form:option value="">Pas d'aéroport</form:option>
						<form:options items="${aeroports}" itemLabel="nom" itemValue="id"></form:options>
					</form:select>
				</div>
				<div class="form-group">
			...
			<form:form method="get" modelAttribute="vol" action="${action}">
				...
				<c:forEach var="e" items="${escales}">
					...
					<div class="form-group">
						...
						<form:input path="${v.e.heureDepart}" cssClass="form-control"
							type="date" />
					</div>
					<div class="form-group">
						<form:label path="${v.e.heureArrivee}">Heure d'arrivée : </form:label>
						<form:input path="${v.e.heureArrivee}" cssClass="form-control"
							type="date" />
					</div>
				</c:forEach>
				<div>
		...
		<c:when test="${i==3}">
			...
			<form:form method="get" modelAttribute="vol" action="${action}">
				<form:hidden path="version" />
				<form:hidden path="heureDepart" />
				<form:hidden path="dateDepart" />
				...
				<form:label path="arrivee.id">Aeroport : </form:label>
